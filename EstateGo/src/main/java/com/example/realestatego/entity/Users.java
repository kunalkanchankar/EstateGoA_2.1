...
@NoArgsConstructor
@Entity
@Inheritance(strategy = InheritanceType.JOINED)	// it specify the inheritance strategy (JOINED strategy)
@DiscriminatorColumn(name = "USER_TYPE", discriminatorType = DiscriminatorType.STRING)	//defining the discriminatory column for joined table inheritance
public class Users {
...
//	@GeneratedValue(strategy = GenerationType.AUTO)
	...
	// Validation annotation for Users @NotEmpty ,@Pattern,  @size,  @NotNull and etc
	...
	private Role role;
//	JoinTable annotation to define the join table for the relationship
